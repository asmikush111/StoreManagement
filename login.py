...
def billdetails():
    ...
    quantity=StringVar()
    cost=StringVar()
    lg = Button(root, text="logout", width=5, fg="white", bg="darkblue", border=2, font=("Comic Sans Ms", 10, "bold"),
                command=logout).grid(row=2, column=0)
    bk = Button(root, text="back", width=5, fg="white", bg="darkblue", border=2, font=("Comic Sans Ms", 10, "bold"),
    ...
    sb = Button(root, text="Show Bills", width=10, fg="white", bg="blue", border=4, font=("Comic Sans Ms", 15, "bold"),
            command=showbills).grid(row=13, column=0)
    gb = Button(root, text="Genrate Bill", width=10, fg="white", bg="blue", border=4, font=("Comic Sans Ms", 15, "bold"),
...
def showbills():
    ...
    showbillitem()
    l = Label(root, text="STARLIGHT RESTAURANT", bg="black", width=50, fg="blue", font=("Comic Sans Ms", 25,"bold","underline","italic")).grid(row=0,column=0,columnspan=6)
    ...
    pb = Button(root, text="Print Bill", width=8, fg="white", bg="blue", border=4, font=("Comic Sans Ms", 15, "bold"),
...
def itemdetails():
    ...
    b1 = Button(root, text="insert", width=10, fg="white", bg="blue", border=5, font=("Comic Sans Ms", 10, "bold"),
    ...
    b2 = Button(root, text="delete", width=10, fg="white", bg="blue", border=5, font=("Comic Sans Ms", 10, "bold"),
    ...
    b3 = Button(root, text="update", width=10, fg="white", bg="blue", border=5, font=("Comic Sans Ms", 10, "bold"),
...
def newwindow():
    ...
    b1=Button(text="Item Details", width=15, fg="white",bg="blue",border=5, font=("Comic Sans Ms", 15, "bold"), command=itemdetails).grid(row=3,column=2)
    q = Label(root, text="").grid(row=4, columnspan=5)
    b2=Button(text="Bill Details", width=15, fg="white",bg="blue",border=5, font=("Comic Sans Ms", 15, "bold"), command=billdetails).grid(row=5,column=2)
    q = Label(root, text="").grid(row=6, columnspan=5)
    b3=Button(text="Logout", width=15, fg="white",bg="blue",border=5, font=("Comic Sans Ms", 15, "bold"), command=logout).grid(row=7,column=2)



def mainheading():
    l = Label(root, text="STARLIGHT RESTAURANT", bg="black", width=35, fg="blue", font=("Comic Sans Ms", 25,"bold","underline","italic")).grid(row=0,column=0,columnspan=6)
...
def loginwindow():
    ...
    b1 = Button(root, text="Login", width=15, fg="white",bg="blue",border=5, font=("Comic Sans Ms", 15, "bold"), command=check).grid(row=6,column=3)
